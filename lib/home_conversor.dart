...
class _HomeConverState extends State<HomeConver> {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(height: 20),
                    currencyTextField(
                      'Iene', 'JPY ', ieneControl, _convertIene),
                    const SizedBox(height: 20),
                    currencyTextField(
  ...
  void _convertDolar(String text) {
    ...
    ieneControl.text =
        ((this.dolar * dolar) / iene).toStringAsFixed(2);
  ...
  void _convertEuro(String text) {
    ...
    ieneControl.text =
        ((this.euro * euro) / iene).toStringAsFixed(2);
  ...
  void _convertIene(String text) {
    ...
    btcControl.text = ((this.iene * iene) / btc).toStringAsFixed(8);
  }
  ...
  void _convertBtc(String text) {
    ...
    ieneControl.text = ((this.btc * btc) / iene).toStringAsFixed(2);
  }
...
Future<Map> getData() async {
  ...
  const requestApi =
      "https://economia.awesomeapi.com.br/json/last/USD-BRL,EUR-BRL,JPY-BRL,BTC-BRL";
